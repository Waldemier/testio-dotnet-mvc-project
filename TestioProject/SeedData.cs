namespace TestioProject
{
    ...
    public static class SeedData
    {
        public static async Task EnsureSeedData(IServiceProvider serviceProvider)
        {
            ...
            //await roleMng.CreateAsync(new IdentityRole { Name = "Student", NormalizedName = "LEARNER" });
            //await roleMng.CreateAsync(new IdentityRole { Name = "Admin", NormalizedName = "ADMIN" });
            //await roleMng.CreateAsync(new IdentityRole { Name = "Admin", NormalizedName = "TEACHER" });
            //await roleMng.CreateAsync(new IdentityRole { Name = "TemporaryLimitedUser", NormalizedName = "TEMPORARYLIMITEDUSER" });
